...
public class BankingOperationService {
    ...
    public BankingOperationService(IUserRepository userRepository, AuditService auditService, ITransactionRepository transactionRepository)
    {
    ...
    public void transfer(String fromUsername, TransferRequestDTO transferRequestDTO) throws ApiException
    {
        ...
        m_transactionRepository.logTransaction(Action.TRANSFER, amount, description, AuditType.TRANSFER_SUCCESS.name(), fromUser, toUser);
    ...
    public void deposit(String username, DepositRequestDTO depositRequestDTO)
    {
        ...
        m_transactionRepository.logTransaction(Action.DEPOSIT, depositRequestDTO.getAmount(), description, AuditType.DEPOSIT_SUCCESS.name(), user);
    }
    ...
    public void withdraw(String username, WithdrawRequestDTO withdrawRequestDTO)
    {
        ...
        m_transactionRepository.logTransaction(Action.WITHDRAW, withdrawRequestDTO.getAmount(), description, AuditType.WITHDRAWAL_SUCCESS.name(), user);
    }
}
